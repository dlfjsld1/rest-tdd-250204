...
public class ApiV1PostControllerTest {
    ...
    void items1() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.data.items.length()").value(3)) // 한 페이지 당 글 개수
    ...
    void items2() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.code").value("200-1"))
                .andExpect(jsonPath("$.msg").value("글 목록 조회가 완료되었습니다."))
                .andExpect(jsonPath("$.data.items.length()").value(pageSize)) // 한 페이지 당 글 개수
    ...
    @Test
    @DisplayName("글 수정 4 - no input data")
    ...
    @Test
    @DisplayName("글 삭제 3 - no permission")
